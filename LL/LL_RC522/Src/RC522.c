...
#define RC522_CS_Enable() LL_GPIO_ResetOutputPin(GPIOA, LL_GPIO_PIN_4)
#define RC522_CS_Disable() LL_GPIO_SetOutputPin(GPIOA, LL_GPIO_PIN_4)

#define RC522_Reset_Enable() LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_0)
#define RC522_Reset_Disable() LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_0)
...
uint8_t RC522_Read_Register(uint8_t Address)
{
  ...
  (void)LL_SPI_WriteRead8(SPI1, Addr);
  data = LL_SPI_WriteRead8(SPI1, 0xFF);
...
void RC522_Write_Register(uint8_t Address, uint8_t data)
{
  ...
  (void)LL_SPI_WriteRead8(SPI1, Addr);
  (void)LL_SPI_WriteRead8(SPI1, data);
